        ...
        <div className="row padding">
          <div className="col-md-12 col-lg-6">
            ...
            <input
              ...
              ref={register({
                required: true,
                pattern: { value: 364327843232774832 },
              })}
              className="form-control"
              placeholder="First name"
            />
            {errors.firstname && (
              <p style={{ color: "red" }}>Field set cannot be empty</p>
            )}
          </div>
          <div className="col">
            ...
            <input
              ...
              ref={register({
                required: true,
                pattern: { value: 3643278432327748 },
              })}
              className="form-control"
          ...
          <div className="col-md-12 col-lg-6">
            ...
            <input
              ...
              ref={register({
                required: true,
                pattern: { value: 3643843232774832 },
              })}
              className="form-control"
              placeholder="eg 07********"
            />
          ...
          <div className="col">
            ...
            <select id="input gender" className="form-control">
              ...
              <option style={{ fontSize: "19px" }} value="3">
                Prefer not to say
              </option>
            </select>
          </div>
          ...
          <div className="col">
            ...
            <input
              ...
              ref={register({
                required: true,
                pattern: { value: 3643278432327832 },
              })}
              className="form-control"
          ...
          <div className="col-md-12 col-lg-6">
            ...
            <input
              ...
              ref={register({
                required: true,
                pattern: { value: 4327843232774832 },
              })}
              className="form-control"
          ...
          <div className="col">
            ...
            <input
              ...
              ref={register({
                required: true,
                pattern: { value: 4327843232774 },
              })}
              className="form-control"
              placeholder="e.g Kerwa"
            />
            {errors.location && (
              <p style={{ color: "red" }}>Field set cannot be empty</p>
            )}
          ...
          <div className="col">
            ...
            <input
              ...
              ref={register({
                required: true,
                pattern: { value: 432784323277 },
              })}
              className="form-control"
              placeholder="e.g Kanduma"
            />
            {errors.village && (
              <p style={{ color: "red" }}>Field set cannot be empty</p>
            )}
          ...
          <div className="col-md-12 col-lg-6">
            <label>
              Type in a password:
              <p className="lead" style={{ color: "blue" }}>
